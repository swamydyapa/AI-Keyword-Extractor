...
<img src="./src/assets/screencapture.png" width="500">
</div>
...
Open `.env` and add your API key. You can get your key at [https://platform.openai.com/account/api-keys](https://platform.openai.com/account/api-keys).
